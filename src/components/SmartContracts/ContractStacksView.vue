      ...
      <q-card flat class="boom-bg full-width">
        ...
        <q-tab-panels v-model="contractDetailTab" animated>
          <q-tab-panel name="overview">
            <StacksDetailsOverview :contract="currentContract" />
          </q-tab-panel>
          <q-tab-panel name="functions">
            <StacksDetailsFunctions :contract="currentContract" />
          </q-tab-panel>
          <q-tab-panel name="events">
            <StacksDetailsEvents :contract="currentContract" />
          </q-tab-panel>
          <q-tab-panel name="code">
            <StacksDetailsCode :contract="currentContract" />
          </q-tab-panel>
        </q-tab-panels>
      </q-card>
    </q-tab-panel>
...
import StacksContractItem from "./StacksContractItem.vue";
import StacksDetailsOverview from "./StacksDetailsOverview.vue";
import StacksDetailsFunctions from "./StacksDetailsFunctions.vue";
import StacksDetailsEvents from "./StacksDetailsEvents.vue";
import StacksDetailsCode from "./StacksDetailsCode.vue";
